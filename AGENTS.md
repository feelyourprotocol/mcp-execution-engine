...
| Path | Role |
| --- | --- |
| `src/simulate/`, `src/diff/`, `src/provenance/`, `src/forks/` | Generic library — query shapes |
...
| simulate | `simulateBytecode()` | `simulate_evm_bytecode` |
| compare | `compareVariants()` | `compare_evm_variants` |
