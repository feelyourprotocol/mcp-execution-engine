...
export const EIP_7702_MODULE: EipCapability = {
  ...
  summary:
    'Prague type-4 transactions attach signed authorizations so an EOA runs delegate contract code for one tx. Prefund the implementation, pass authorizationList, call the authority via run_transaction — compare with Cancun where 7702 is inactive.',
  changeNature: 'new-exec-model',
  runnable: true,
  shapes: ['transaction', 'inspect'],
  keywords: ['7702', 'eoa', 'delegation', 'set-code', 'authorization list', 'type-4'],
  relatedForks: ['prague', 'pectra'],
  status: 'Final',
